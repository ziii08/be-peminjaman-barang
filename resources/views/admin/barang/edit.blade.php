...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-pencil me-2"></i>Edit Barang</h2>
...
<div class="modern-card">
    <div class="card-header-modern">
        <h5><i class="bi bi-box me-2"></i>Form Edit Barang</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.barang.update', $barang) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('stok_total') is-invalid @enderror" 
                               id="stok_total" name="stok_total" value="{{ old('stok_total', $barang->stok_total) }}" 
                               min="1" required>
            ...
            <div class="mb-3">
                ...
                @if($barang->foto)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $barang->foto) }}" alt="{{ $barang->nama_barang }}" class="img-thumbnail" style="max-width: 200px;">
